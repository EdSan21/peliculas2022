...
class NowPlayingRespond {
    ...
    factory NowPlayingRespond.fromJson(String str) => NowPlayingRespond.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory NowPlayingRespond.fromMap(Map<String, dynamic> json) => NowPlayingRespond(
